...
if($is_mobile_pay) {
	...
	require_once(EYOOM_SHOP_PATH.'/personalpayform.sub.php');
} else {
...
$tpl->define(array(
	'personalpayform_sub_pc'	=> 'skin_pc/shop/' . $eyoom['shop_skin'] . '/personalpayform.sub.html',
	'personalpayform_sub_mo'	=> 'skin_mo/shop/' . $eyoom['shop_skin'] . '/personalpayform.sub.html',
	'personalpayform_sub_bs'	=> 'skin_bs/shop/' . $eyoom['shop_skin'] . '/personalpayform.sub.html',
));

// Template define
$tpl->define_template('shop',$eyoom['shop_skin'],'personalpayform.skin.html');
...
// 사용자 프로그램
@include_once(EYOOM_USER_PATH.'/shop/personalpayform.php');
