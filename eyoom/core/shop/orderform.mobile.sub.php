...
if( is_inicis_simple_pay() ){   //이니시스 삼성페이 또는 Lpay 사용시
	...
	$samsungpay_common = ob_get_contents();
	ob_end_clean();
}
...
if( is_inicis_simple_pay() ){   //이니시스 삼성페이 또는 lpay 사용시
	...
	$samsungpay_form1 = ob_get_contents();
	ob_end_clean();
}
...
ob_start();
include_once (G5_MSHOP_PATH.'/'.$default['de_pg_service'].'/orderform.2.php');
...
if( is_inicis_simple_pay() ){   //이니시스 삼성페이 또는 lpay 사용시
	...
	$samsungpay_form2 = ob_get_contents();
	ob_end_clean();
}
...
if ($default['de_escrow_use']) {
	...
	if( is_inicis_simple_pay() ){   //이니시스 삼성페이 또는 lpay 사용시
		...
		$samsungpay_form3 = ob_get_contents();
		ob_end_clean();
	}
}
...
if( is_inicis_simple_pay() ){   //이니시스 삼성페이 또는 lpay 사용시
	...
	$samsungpay_script = ob_get_contents();
	ob_end_clean();
}
