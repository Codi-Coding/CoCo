...
if(!$ckey || $ckey != $key)
    alert(_t('올바른 방법으로 이용해 주십시오.'), G5_URL);
?>

<p class="rg_em_p"><?php echo _t('메일인증을 받지 못한 경우 회원정보의 메일주소를 변경 할 수 있습니다.'); ?></p>
...
<div class="btn_confirm">
    <input type="submit" id="btn_submit" class="btn_submit" value="<?php echo _t('인증메일변경'); ?>">
