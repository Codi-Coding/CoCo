if (typeof(CAPSLOCK_JS) == 'undefined') // 한번만 실행
{
    if (typeof g5_url == 'undefined')
        alert('g5_url 변수가 선언되지 않았습니다. js/capslock.js');
    ...
    document.write("<div id='capslock_info' style='display:none; position:absolute;'><img src='"+g5_url+"/img/capslock.gif'></div>");
}
