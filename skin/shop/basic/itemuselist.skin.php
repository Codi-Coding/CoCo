...
<div id="sps_sch">
    ...
    <button type="submit" value="<?php echo _t('검색'); ?>" class="sch_btn"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only">검색</span></button>
    </div>
</div>
</form>
...
<div id="sps">
    ...
    <li>
        ...
        <section class="sps_section">
            ...
            <dl class="sps_dl">
                <dt class="sound_only"><?php echo _t('평가점수'); ?></dt>
                <dd><img src="<?php echo G5_URL; ?>/shop/img/s_star<?php echo $star; ?>.png" alt="<?php echo _t('별'); ?><?php echo $star; ?><?php echo _t('개'); ?>" width="80"></dd>
            ...
            <div class="sps_con_btn"><button class="sps_con_<?php echo $i; ?>"><?php echo _t('내용보기'); ?> <i class="fa fa-caret-down" aria-hidden="true"></i></button></div>
        </section>
