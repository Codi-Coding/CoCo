...
<aside id="sbsk" class="op_area">
    ...
    if ($i==0)
        echo '<li class="li_empty">'._t('장바구니 상품 없음').'</li>'.PHP_EOL;
    ?>
    </ul>
    <?php if($i){ ?><button type="submit" class="btn02 btn_buy"><i class="fa fa-credit-card" aria-hidden="true"></i> <?php echo _t('바로구매'); ?></button><?php } ?>
    <a href="<?php echo G5_SHOP_URL; ?>/cart.php" class="btn01 go_cart"><?php echo _t('장바구니 바로가기'); ?></a>
    </form>
</aside>
<!-- } 장바구니 간략 보기 끝 -->
