...
<section id="sit_use_list">
    ...
    ?>
        ...
        <li class="sit_use_li">
                ...
                <button type="button" class="sit_use_li_title"><?php echo _t('내용보기'); ?> <i class="fa fa-caret-down" aria-hidden="true"></i></button>
                <dl class="sit_use_dl">
                    <dt><?php echo _t('평점'); ?><dt>
                    <dd class="sit_use_star"><img src="<?php echo G5_SHOP_URL; ?>/img/s_star<?php echo $is_star; ?>.png" alt="<?php echo _t('별'); ?><?php echo $is_star; ?><?php echo _t('개'); ?>" width="85"></dd>
