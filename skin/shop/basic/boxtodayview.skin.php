...
<div id="stv" class="op_area">
    ...
    ?>
        ...
        $(function() {
            ...
            if (itemQty > itemShow)
            {
                $('#stv_btn').append('<button type="button" id="up"><i class="fa fa-angle-left" aria-hidden="true"></i> <?php echo _t('이전'); ?></button><button type="button" id="down"><?php echo _t('다음'); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></button>');
            }
            var Flag = 1; // 페이지
        ...
        <p class="li_empty"><?php echo _t('없음'); ?></p>
