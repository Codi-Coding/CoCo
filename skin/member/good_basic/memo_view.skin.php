...
<div id="memo_view" class="new_win mbskin">
    ...
    <div class="win_btn">
        ...
        <?php }  ?>
        <?php if ($kind == 'recv') {  ?><a href="./memo_form.php?me_recv_mb_id=<?php echo $mb['mb_id'] ?>&amp;me_id=<?php echo $memo['me_id'] ?>"><?php echo _t('답장'); ?></a><?php }  ?>
        <a href="./memo.php?kind=<?php echo $kind ?>"><?php echo _t('목록보기'); ?></a>
