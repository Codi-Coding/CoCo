			...
			<div class="col-sm-3 col-xs-6">
				<div class="form-group">
					...
					<select name="sfl" id="sfl" class="form-control input-sm">
						...
						<option value="a.iq_name"    <?php echo get_selected($sfl, "a.iq_id"); ?>>작성자명</option>
...
<div class="div-box-light"> 
	총 <b><?php echo number_format($total_count);?></b>개의 문의가 등록되어 있습니다.
</div>
...
<div class="qa-media">	
	...
	?>
		<div class="div-title-wrap">
			<div class="div-title">
				<strong>
					<a href="<?php echo $list[$i]['iq_href']; ?>">
		...
		<div class="media">
			...
			<div class="media-body">
				<div class="media-info text-muted">
					...
					<time datetime="<?php echo date('Y-m-d\TH:i:s+09:00', $list[$i]['iq_time']) ?>"><?php echo apms_date($list[$i]['iq_time'], 'orangered', 'before', 'm.d', 'Y.m.d');?></time>
				</div>
				<div class="media-content">
					<a href="<?php echo $list[$i]['iq_href']; ?>">
						<?php if($list[$i]['iq_secret']) { ?>
							<img src="<?php echo $skin_url;?>/img/icon_secret.gif" alt="">
						<?php } ?>
						<span class="text-muted"><?php echo apms_cut_text($list[$i]['iq_question'], $wset['cont'], '… <span class="font-11 text-muted">더보기</span>'); ?></span>
					</a>
				</div>
