...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <header>
            <h1><?php echo $list[$i]['wr_name'] ?><?php echo _t('님의 댓글'); ?></h1>
...
<?php if ($is_comment_write) {
    ...
    <aside id="bo_vc_w">
        ...
        <tr>
            <th scope="row"><label for="wr_password"><?php echo _t('패스워드'); ?><strong class="sound_only"><?php echo _t('필수'); ?></strong></label></th>
        ...
        <tr>
            ...
            <td>
                ...
                <textarea id="wr_content" name="wr_content" maxlength="10000" required class="required" title="<?php echo _t('내용'); ?>"
    ...
    function fviewcomment_submit(f)
    {
        ...
        if (typeof(f.wr_password) != 'undefined')
        {
            ...
            {
                alert('<?php echo _t('패스워드가 입력되지 않았습니다.'); ?>');
                f.wr_password.focus();
                return false;
            }
        }
