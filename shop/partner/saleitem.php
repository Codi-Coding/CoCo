...
$sql_common = " from {$g5['g5_shop_cart_table']} a left join {$g5['g5_shop_item_table']} b on ( a.it_id = b.it_id ) where a.pt_id = '{$member['mb_id']}' and a.ct_status = '완료' and a.ct_select = '1' $sql_date $sql_search ";
...
include_once($skin_path.'/saleitem.skin.php');
