...
//계정현황
$account = apms_balance_sheet($member['mb_id'], 1);

//신청현황
$sql_common = " from {$g5['apms_payment']} where mb_id = '{$member['mb_id']}' and pp_field = '1' ";
...
@include_once($skin_path.'/mkt.paylist.skin.php');
