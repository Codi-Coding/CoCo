...
if(defined('G5_USE_OLD_CODE') && G5_USE_OLD_CODE) { include_once G5_SHOP_PATH.'/orderinquiryview_old.php'; return; }
    ...
    <section id="sod_fin_list">
        ...
        <div class="tbl_head03 tbl_wrap">
            ...
            <tr>
                ...
                <th scope="col" id="th_itpt"><?php echo _t('적립포인트'); ?></th>
            ...
            <tr>
                ...
                <td headers="th_itname" colspan="7" class="td_bdno"><a href="./item.php?it_id=<?php echo $row['it_id']; ?>"><?php echo _t($row['it_name']); ?></a></td>
            </tr>
            <?php } ?>
            <tr>
                <td headers="th_itopt" class="td_bdno"><?php echo get_text(_t($opt['ct_option'])); ?></td>
                <td headers="th_itqty" class="td_mngsmall"><?php echo number_format($opt['ct_qty']); ?></td>
                <td headers="th_itprice" class="td_numbig text_right"><?php echo number_format(_cc($opt_price), $g5['decimal_point']); ?></td>
                <td headers="th_itsum" class="td_numbig text_right"><?php echo number_format(_cc($sell_price), $g5['decimal_point']); ?></td>
                <td headers="th_itpt" class="td_numbig text_right"><?php echo number_format($point); ?></td>
                <td headers="th_itsd" class="td_dvr"><?php echo number_format(_cc($ct_send_cost), $g5['decimal_point']); ?></td>
    ...
    <div class="sod_right">
        <ul id="sod_bsk_tot">
            <li class="sod_bsk_dvr">
                <span><?php echo _t('주문총액'); ?></span>
                <strong><?php echo number_format(_cc($od['od_cart_price']), $g5['decimal_point']); ?> <?php echo _t('원'); ?></strong>
            </li>
            <?php if($od['od_cart_coupon'] > 0) { ?>
            <li class="sod_bsk_dvr">
                <span><?php echo _t('개별상품 쿠폰할인'); ?></span>
                <strong><?php echo number_format($od['od_cart_coupon']); ?> <?php echo _t('원'); ?></strong>
                
            </li>
            <?php } ?>
            <?php if($od['od_coupon'] > 0) { ?>
            <li class="sod_bsk_dvr">
                <span><?php echo _t('주문금액 쿠폰할인'); ?></span>
                <strong><?php echo number_format($od['od_coupon']); ?> <?php echo _t('원'); ?></strong>
            ...
            <li class="sod_bsk_dvr">
                ...
                <strong><?php echo number_format(_cc($od['od_send_cost']), $g5['decimal_point']); ?> <?php echo _t('원'); ?></strong>
                
            </li>
            <?php } ?>
            <?php if($od['od_send_coupon'] > 0) { ?>
            <li class="sod_bsk_dvr">
                <span><?php echo _t('배송비 쿠폰할인'); ?></span>
                <strong><?php echo number_format($od['od_send_coupon']); ?> <?php echo _t('원'); ?></strong>
                
            </li>
            <?php } ?>
            <?php if ($od['od_send_cost2'] > 0) { ?>
            <li class="sod_bsk_dvr">
                <span><?php echo _t('추가배송비'); ?></span>
                <strong><?php echo number_format(_cc($od['od_send_cost2']), $g5['decimal_point']); ?> <?php echo _t('원'); ?></strong>
            </li>
            <?php } ?>
            <?php if ($od['od_cancel_price'] > 0) { ?>
            <li class="sod_bsk_dvr">
                <span><?php echo _t('취소금액'); ?></span>
                <strong><?php echo number_format(_cc($od['od_cancel_price']), $g5['decimal_point']); ?> <?php echo _t('원'); ?></strong>
                
            </li>
            <?php } ?>
            <li class="sod_bsk_cnt">
                <span><?php echo _t('총계'); ?></span>
                <strong><?php echo number_format(_cc($tot_price), $g5['decimal_point']); ?> <?php echo _t('원'); ?></strong>
            </li>
            <li class="sod_bsk_point">
                <span><?php echo _t('적립포인트'); ?></span>
                <strong><?php echo number_format($tot_point); ?> <?php echo _t('점'); ?></strong>
            </li>
        </ul>
        ...
        <section id="sod_fin_cancel">
            ...
            <div id="sod_fin_cancelfrm">
                ...
                <input type="text" name="cancel_memo" id="cancel_memo" required class="frm_input required" size="40" maxlength="100" placeholder="<?php echo _t('취소사유'); ?>">
