...
<div id="cp_frm" class="od_coupon">
    ...
    <div class="tbl_head02 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_mngsmall"><button type="button" class="cp_apply"><?php echo _t('적용'); ?></button></td>
        </tr>
        <?php
        }
        ?>
    ...
    <?php
        ...
        echo '<div class="empty_list">'._t('사용할 수 있는 쿠폰이 없습니다.').'</div>';
    }
    ?>
    <div class="btn_confirm">
        <button type="button" id="cp_close" class="btn_close"><i class="fa fa-times" aria-hidden="true"></i><span class="sound_only"><?php echo _t('닫기'); ?></span></button>
    </div>
</div>
<!-- } 쿠폰 선택 끝 -->
