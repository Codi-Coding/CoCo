...
<div id="sod_ws">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <thead>
        <tr>
            <th scope="col"><?php echo _t('선택'); ?></th>
        ...
        <tr>
            ...
            <td class="td_mngsmall"><a href="./wishupdate.php?w=d&amp;wi_id=<?php echo $row['wi_id']; ?>"><?php echo _t('삭제'); ?></a></td>
        </tr>
        <?php
        }
    ...
    <div id="sod_ws_act">
        <button type="submit" class="btn01" onclick="return fwishlist_check(document.fwishlist,'');"><?php echo _t('장바구니 담기'); ?></button>
        <button type="submit" class="btn02" onclick="return fwishlist_check(document.fwishlist,'direct_buy');"><?php echo _t('주문하기'); ?></button>
    </div>
    </form>
</div>
