...
<div id="sod_frm">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
            ...
            if($is_member) {
                ...
                if($cp_count) {
                    $cp_button = '<button type="button" class="cp_btn btn_frmline">'._t('적용').'</button>';
                    $it_cp_count++;
                }
            }
        ...
        <tr>
            ...
            <td class="td_numbig"><?php echo number_format(_cc($row['ct_price']), $g5['decimal_point']); ?></td>
            <td class="td_mngsmall"><?php echo $cp_button; ?></td>
            <td class="td_numbig"><span class="total_price"><?php echo number_format(_cc($sell_price), $g5['decimal_point']); ?></span></td>
        ...
        if ($i == 0) {
            //echo '<tr><td colspan="7" class="empty_table">'._t('장바구니에 담긴 상품이 없습니다.').'</td></tr>';
    ...
    <dl id="sod_bsk_tot">
        ...
        <dt class="sod_bsk_coupon"><?php echo _t('쿠폰할인'); ?></dt>
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td>
                    ...
                    <label for="od_addr1"><?php echo _t('기본주소'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label><br>
                    <input type="text" name="od_addr2" value="<?php echo get_text($member['mb_addr2']) ?>" id="od_addr2" class="frm_input frm_address" size="60">
                    <label for="od_addr2"><?php echo _t('상세주소'); ?></label>
                    <br>
                    ...
                    <label for="od_addr3"><?php echo _t('참고항목'); ?></label><br>
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td id="sod_frm_addr">
                    ...
                    <label for="od_b_addr1"><?php echo _t('기본주소'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label><br>
                    <input type="text" name="od_b_addr2" id="od_b_addr2" class="frm_input frm_address" size="60">
                    <label for="od_b_addr2"><?php echo _t('상세주소'); ?></label>
                    <br>
                    <input type="text" name="od_b_addr3" id="od_b_addr3" readonly="readonly" class="frm_input frm_address" size="60">
                    <label for="od_b_addr3"><?php echo _t('참고항목'); ?></label><br>
    ...
    <section id="sod_frm_pay">
        ...
        if ($default['de_bank_use']) {
            $multi_settle++;
            echo '<input type="radio" id="od_settle_bank" name="od_settle_case" value="무통장" '.$checked.'> <label for="od_settle_bank">'._t('무통장입금').'</label>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($default['de_vbank_use']) {
            $multi_settle++;
            echo '<input type="radio" id="od_settle_vbank" name="od_settle_case" value="가상계좌" '.$checked.'> <label for="od_settle_vbank">'.$escrow_title._t('가상계좌').'</label>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($default['de_iche_use']) {
            $multi_settle++;
            echo '<input type="radio" id="od_settle_iche" name="od_settle_case" value="계좌이체" '.$checked.'> <label for="od_settle_iche">'.$escrow_title._t('계좌이체').'</label>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($default['de_hp_use']) {
            $multi_settle++;
            echo '<input type="radio" id="od_settle_hp" name="od_settle_case" value="휴대폰" '.$checked.'> <label for="od_settle_hp">'._t('휴대폰').'</label>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($default['de_card_use']) {
            $multi_settle++;
            echo '<input type="radio" id="od_settle_card" name="od_settle_case" value="신용카드" '.$checked.'> <label for="od_settle_card">'._t('신용카드').'</label>'.PHP_EOL;
            $checked = '';
        }
        ...
        ?>
            <p id="sod_frm_pt"><?php echo _t('보유포인트'); ?>(<?php echo display_point($member['mb_point']); ?>)<?php echo _t('중'); ?> <strong id="use_max_point"><?php echo _t('최대'); ?> <?php echo display_point($temp_point); ?></strong><?php echo _t('까지 사용 가능'); ?></p>
            <input type="hidden" name="max_temp_point" value="<?php echo $temp_point; ?>">
            <label for="od_temp_point"><?php echo _t('사용 포인트'); ?></label>
            <input type="text" name="od_temp_point" value="0" id="od_temp_point" class="frm_input" size="10"><?php echo _t('점'); ?> (<?php echo $point_unit; ?><?php echo _t('점 단위로 입력하세요.'); ?>)
        <?php
            $multi_settle++;
            }
        }
    ...
    <a href="javascript:history.go(-1);" class="btn01">'._t('취소').'</a>
    </div>
    ';
...
$(function() {
    ...
    $(document).on("click", ".cp_apply", function() {
        ...
        if(!$cp_row_el.find(".cp_cancel").size())
            $cp_btn_el.after("<button type=\"button\" class=\"cp_cancel btn_frmline\"><?php echo _t('취소'); ?></button>");
    });
