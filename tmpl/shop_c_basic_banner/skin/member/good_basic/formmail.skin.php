...
<div id="formmail" class="new_win mbskin">
    ...
    <div class="tbl_frm01 tbl_form">
        <table>
        <caption><?php echo _t('메일쓰기'); ?></caption>
        <tbody>
        <?php if (!$is_member) {  ?>
        <tr>
            <th scope="row"><label for="fnick"><?php echo _t('이름'); ?><strong class="sound_only"><?php echo _t('필수'); ?></strong></label></th>
            <td><input type="text" name="fnick" id="fnick" required class="frm_input required"></td>
        </tr>
        <tr>
            <th scope="row"><label for="fmail">E-mail<strong class="sound_only"><?php echo _t('필수'); ?></strong></label></th>
        ...
        <tr>
            <th scope="row"><?php echo _t('형식'); ?></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="file1"><?php echo _t('첨부 파일'); ?> 1</label></th>
            <td>
                <input type="file" name="file1"  id="file1"  class="frm_input">
                <?php echo _t('첨부 파일은 누락될 수 있으므로 메일을 보낸 후 파일이 첨부 되었는지 반드시 확인해 주시기 바랍니다.'); ?>
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="file2"><?php echo _t('첨부 파일'); ?> 2</label></th>
