...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            ...
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/shop_logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
            <?php } else { ?>
        ...
        <ul id="tnb">
            ...
            <!--<li><a href="<?php echo G5_BBS_URL; ?>/group.php?gr_id=board">커뮤니티</a></li>-->
...
<div id="wrapper">
    ...
    <div id="aside">
        ...
        <?php ///echo outlogin('shop_basic_old'); // 아웃로그인 ?>
        <?php ///include_once(G5_SHOP_SKIN_PATH.'/boxcategory.skin.php'); // 상품분류 ?>
        <?php ///include_once(G5_SHOP_SKIN_PATH.'/boxcart.skin.php'); // 장바구니 ?>
        <?php ///include_once(G5_SHOP_SKIN_PATH.'/boxwish.skin.php'); // 위시리스트 ?>
        <?php ///include_once(G5_SHOP_SKIN_PATH.'/boxevent.skin.php'); // 이벤트 ?>
        <?php ///include_once(G5_SHOP_SKIN_PATH.'/boxcommunitygroup.skin.php'); // 커뮤니티 ?>
        <!-- 쇼핑몰 배너 시작 { -->
