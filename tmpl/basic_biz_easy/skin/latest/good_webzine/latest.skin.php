...
<div class="lt_gallery_wz">
    <strong class="lt_title"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>"><?php echo _t($bo_subject) ?></a></strong><!-- cache problem -->
    <ul>
    <?php
    ...
    ?>
        <li>
            <!--<span class="left"><a href="<?php echo $href?>" target="_self"><img src="<?php echo $img_url?>" alt="<?php echo $list[$i]['wr_subject']?>"></a></span>-->
            <span class="left"><a href="<?php echo $href?>" target="_self"><img src="<?php echo $img_src?>" alt="<?php echo _t($list[$i]['wr_subject'])?>"></a></span>
            <span class="right"><a href="<?php echo $href?>" target="_self"><font class="title">[<?php echo _t($list[$i]['wr_subject'])?>]</font><br><?php echo cut_str(stripslashes(_t($list[$i]['content'])), $subject_len, ' ...')?></a></span>
        </li>
    <?php } ?>
    </ul>
