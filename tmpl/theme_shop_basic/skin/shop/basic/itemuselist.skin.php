...
<div id="sps">
    ...
    <!-- <p><?php echo $config['cf_title']; ?> <?php echo _t('전체 사용후기 목록입니다.'); ?></p> -->
    ...
    <li>
        ...
        <section class="sps_section">
            ...
            <dl class="sps_dl">
                ...
                <dd><img src="<?php echo G5_URL; ?>/shop/img/s_star<?php echo $star; ?>.png" alt="<?php echo _t('별'); ?><?php echo $star; ?><?php echo _t('개'); ?>"></dd>
            </dl>
    ...
    <li class="sps_reply">
        ...
        <section class="sps_section">
            ...
            <div class="sps_con_btn"><button class="sps_con_<?php echo $i; ?>_reply"><?php echo _t('보기'); ?></button></div>
        </section>
    </li>
    <?php }     //end if ?>
