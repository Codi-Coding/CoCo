...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <fieldset id="hd_sch">
            ...
            <label for="sch_stx" class="sound_only"><?php echo _t('검색어'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label>
        ...
        <ul id="tnb">
            ...
            <li><a href="<?php echo G5_BBS_URL ?>/current_connect.php"><?php echo _t('접속자'); ?> <?php echo connect('theme/basic'); // 현재 접속자수, 테마의 스킨을 사용하려면 스킨을 theme/basic 과 같이 지정  ?></a></li>
...
<div id="wrapper">
    <div id="aside">
        ...
        <?php echo outlogin('good_basic'); // 외부 로그인, 테마의 스킨을 사용하려면 스킨을 theme/basic 과 같이 지정 ?>
