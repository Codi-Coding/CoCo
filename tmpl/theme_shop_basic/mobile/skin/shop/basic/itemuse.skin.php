...
<a href="<?php echo $itemuse_form; ?>" class="qa_wr itemuse_form " onclick="return false;"><?php echo _t('사용후기 쓰기'); ?><span class="sound_only"> <?php echo _t('새 창'); ?></span></a>
...
<div id="sit_use_list">
    ...
    ?>
        ...
        <li class="sit_use_li">
            ...
            <dl class="sit_use_dl">
                ...
                <dt><?php echo _t('선호도'); ?><dt>
                <dd class="sit_use_star"><img src="<?php echo G5_SHOP_URL; ?>/img/s_star<?php echo $is_star; ?>.png" alt="<?php echo _t('별'); ?><?php echo $is_star; ?><?php echo _t('개'); ?>"></dd>
            </dl>
            ...
            <div id="sit_use_con_<?php echo $i; ?>" class="sit_use_con">
                ...
                <div class="sit_use_reply">
                    <div class="use_reply_icon"><?php echo _t('답변'); ?></div>
    ...
    if (!$i) echo '<p class="sit_empty">'._t('사용후기가 없습니다.').'</p>';
    ?>
</div>
...
<div id="sit_use_wbtn">
    <a href="<?php echo $itemuse_list; ?>" id="itemuse_list" class="btn01"><?php echo _t('더보기'); ?> +</a>
</div>
