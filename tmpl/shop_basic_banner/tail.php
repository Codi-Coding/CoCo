...
<div id="ft">
    <div>
        ...
        <a href="<?php echo G5_URL; ?>/" id="ft_logo"><img src="<?php echo G5_IMG_URL; ?>/shop_ft.png" alt="처음으로"></a>
        <?php } else { ?>
        <a href="<?php echo G5_URL; ?>/" id="ft_logo"><img src="<?php echo $g5['tmpl_url']; ?>/images/ft.png" alt="처음으로"></a>
        <?php } ?>
        <ul>
