...
<div id="hd">
    ...
    <aside id="hd_qnb">
        <h2>쇼핑몰 퀵메뉴</h2>
        <div>
            <a href="<?php echo G5_SHOP_URL; ?>/cart.php"><img src="<?php echo $g5['tmpl_url']; ?>/img/hd_nb_cart.gif" alt="장바구니"></a>
            <a href="<?php echo G5_SHOP_URL; ?>/wishlist.php"><img src="<?php echo $g5['tmpl_url']; ?>/img/hd_nb_wish.gif" alt="위시리스트"></a>
            <a href="<?php echo G5_SHOP_URL; ?>/orderinquiry.php"><img src="<?php echo $g5['tmpl_url']; ?>/img/hd_nb_deli.gif" alt="주문/배송조회"></a>
        </div>
    </aside>
    <?php } ?>
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo"><a href="<?php echo G5_URL; ?>/"><img src="<?php echo G5_IMG_URL ?>/shop_logo.png" alt="<?php echo $config['cf_title']; ?>"></a></div>
        <?php } else { ?>
        <div id="logo"><a href="<?php echo G5_URL; ?>/"><img src="<?php echo $g5['tmpl_url']; ?>/images/logo.png" alt="<?php echo $config['cf_title']; ?>"></a></div>
        <?php } ?>
...
<div id="wrapper">
    ...
    <div id="aside">
        <?php ///echo outsearch('good_shopsearch_basic'); ?>
        ...
        <?php echo '<div style="height:5px"></div>'; // 공백 ?>

        <?php echo popular('good_shop_basic_border'); ?>

        <?php echo visit('good_shop_basic_border'); // 방문자 ?>

        <?php echo poll('good_shop_basic_border'); // 투표 ?>
