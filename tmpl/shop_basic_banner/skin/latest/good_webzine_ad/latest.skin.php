...
<div class="lt_gallery_wz_ad">
    ...
    ?>
        <li>
            <!--<a href="<?php echo $href?>" target="_self"><img src="<?php echo $img_url?>" alt="<?php echo $list[$i]['wr_subject']?>"></a>-->
            <a href="<?php echo $href?>" target="_self"><img src="<?php echo $img_src?>" alt="<?php echo $list[$i]['wr_subject']?>"></a>
        </li>
    <?php } ?>
    </ul>
</div>
