    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
        ...
        for ($i=0; $i<count($list[$idx]) && $k<$rows; $i++, $k++) {
            ...
            {
                $comment_def = '<span class="cmt_def">'._t('댓글').' | </span>';
        ...
        <div class="sch_more"><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;<?php echo $search_query ?>"><strong><?php echo _t($bo_subject[$idx]) ?></strong> <?php echo _t('결과 더보기'); ?></a></div>
