...
<aside id="scomm">
    ...
    <?php
    if($g5['is_db_trans'] && file_exists($g5['locale_path'].'/include/skin.shop.boxcommunitygroup.skin.inc.php')) {
        include_once $g5['locale_path'].'/include/skin.shop.boxcommunitygroup.skin.inc.php';
    } else {
