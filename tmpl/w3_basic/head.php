...
<?php } ?>
<?php } /// for ?>
    <a href="<?php echo G5_BBS_URL; ?>/search.php" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-black" title="Search"><i class="fa fa-search"></i></a>
...
<?php } ?>
<?php } /// for ?>
    <a href="<?php echo G5_BBS_URL; ?>/search.php" class="w3-bar-item w3-button"><?php echo _t('Search'); ?></a>
<?php if ($is_admin) { ?>
    <a href="<?php echo G5_ADMIN_URL ?>" class="w3-bar-item w3-button"><?php echo _t('관리자'); ?></a>
<?php } else if ($is_member) { ?>
    <a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=<?php echo G5_BBS_URL ?>/register_form.php" class="w3-bar-item w3-button"><?php echo _t('정보수정'); ?></a>
...
<div id="container" style="width:100%;padding-top:90px">
<?php } ?>
