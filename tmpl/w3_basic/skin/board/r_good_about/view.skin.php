...
$contact_addr = array_map(trim, explode(':::', $view['wr_1'])); 
$google_map_pos = $view['wr_2']; 
$google_map_key = $view['wr_3']; 
...
<div id="bo_v_table"><?php echo _t($board['bo_subject']); ?></div>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h1 id="bo_v_title">
            ...
            echo _t(cut_str(get_text($view['wr_subject']), 70)); // 글제목 출력
            ?>
        </h1>
    </header>
         ...
         ?>
            <li>
                <a href="<?php echo $view['file'][$i]['href'];  ?>" class="view_file_download">
                    <img src="<?php echo $board_skin_url ?>/img/icon_file.gif" alt="<?php echo _t('첨부'); ?>">
                    <strong><?php echo $view['file'][$i]['source'] ?></strong>
                    <?php echo $view['file'][$i]['bf_content'] ?> (<?php echo $view['file'][$i]['size'] ?>)
                </a>
                <span class="bo_v_file_cnt"><?php echo $view['file'][$i]['download'] ?><?php echo _t('회'); ?> <?php echo _t('다운로드'); ?></span>
    ...
    <section id="bo_v_atc">
        ...
        <!--<?php for ($i=1; $i<=10; $i++) { ?>
        <ul style="margin:0;padding:5px;list-style:none">
            <li><?php echo _t('옵션'); ?> #<?php echo $i ?> <?php echo $view['wr_'.$i]; ?></li>
        </ul>
        <?php } ?>-->

	<?php if($contact_addr[0] or $contact_addr[1] or $contact_addr[2]) { ?>
	<!-- Address -->
	<div style="padding:0 0 20px">
	<b>Address</b>: <?php echo $contact_addr[0]; ?>;
	<b>Tel</b>: <?php echo $contact_addr[1]; ?>;
	<b>Email</b>: <?php echo $contact_addr[2]; ?>
	</div>
	<!-- /// Address -->
	<?php } ?>

	<?php if($google_map_pos && $google_map_key) { ?>
	<!-- Google Maps -->
