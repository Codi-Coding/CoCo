...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/style.gallery.css">', 0);
?>
            ...
            <ul class="gall_con">
                <li class="gall_href">
                    ...
                    if ($list[$i]['is_notice']) { // 공지사항 ?>
                        <strong style="width:<?php echo $board['bo_mobile_gallery_width'] ?>px;height:<?php echo $board['bo_gallery_height'] ?>px">공지</strong>
                    <?php
                    } else {
                        $thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], $board['bo_mobile_gallery_width'], $board['bo_gallery_height']);

                        if($thumb['src']) {
                            $img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" width="'.$board['bo_mobile_gallery_width'].'" height="'.$board['bo_gallery_height'].'">';
                        } else {
                            $img_content = '<span style="width:'.$board['bo_mobile_gallery_width'].'px;height:'.$board['bo_gallery_height'].'px">no image</span>';
                        }
                ...
                <?php if ($is_good) { ?><li><span class="gall_subject"><?php echo _t('추천'); ?>: </span><?php echo $list[$i]['wr_good'] ?></li><?php } ?>
                <?php if ($is_nogood) { ?><li><span class="gall_subject"><?php echo _t('비추천'); ?>: </span><?php echo $list[$i]['wr_nogood'] ?></li><?php } ?>
            </ul>
        </li>
        <?php } ?>
