...
<aside id="swish">
    ...
    <ul>
    <?php
    if($g5['is_db_trans'] && file_exists($g5['locale_path'].'/include/skin.shop.boxwish.skin.inc.php')) {
        include_once $g5['locale_path'].'/include/skin.shop.boxwish.skin.inc.php';
    } else {
    ...
    for ($i=0; $row=sql_fetch_array($hresult); $i++)
    {
        ...
        echo '<a href="'.G5_SHOP_URL.'/wishlist.php">'._t($it_name).'</a>';
        echo '</li>';
    }
