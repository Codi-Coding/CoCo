...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrp">
            ...
            <td>
                <div id="autosave_wrapper">
                    ...
                    <div id="autosave_pop">
                        ...
                        <div><button type="button" class="autosave_close"><img src="<?php echo $board_skin_url; ?>/img/btn_close.gif" alt="닫기" border='0'></button></div>
                        <ul></ul>
                        <div><button type="button" class="autosave_close"><img src="<?php echo $board_skin_url; ?>/img/btn_close.gif" alt="닫기" border='0'></button></div>
                    </div>
                    <?php } ?>
        ...
        <tr>
            <th scope="row"><label for="wr_1">포인트<strong class="sound_only">필수</strong></label></th>
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required numeric class="frm_input required" size="10" maxlength="255"> 
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <th scope="row"><label for="wr_2">수량<strong class="sound_only">필수</strong></label></th>
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" required numeric class="frm_input required" size="10" maxlength="255"> 
                </div>
            </td>
        </tr>
        <tr>
        <tr>
            <th scope="row"><label for="wr_8">중복주문<br>허용<strong class="sound_only">필수</strong></label></th>
            <td>
                <div id="autosave_wrapper">
				<?php  if($write['wr_8'] == "Open" || $write['wr_8'] == "") $e = "checked"; else $f = "checked"; ?>
                    <input type="radio" name="wr_8" value="Open" <?php echo $e; ?> id="wr_8"  class="frm_input required" >  가능      <input type="radio" name="wr_8" value="Close" id="wr_8" <?php echo $f; ?>  class="frm_input required"> 불가능
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
				...
				<?php  if($write['wr_10'] == "Open" || $write['wr_10'] == "") $e = "checked"; else $f = "checked"; ?>
                    <input type="radio" name="wr_10" value="Open" <?php echo $e; ?> id="wr_10"  class="frm_input required" >  Open      <input type="radio" name="wr_10" value="Close" id="wr_10" <?php echo $f; ?>  class="frm_input required"> Close
                </div>
            </td>
        </tr>
        <tr>
