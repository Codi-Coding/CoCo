...
function fsearchbox_submit(f)
{
	...
	<div id="head">
		...
		<div class="top">
			...
			<?php } else { ?>
			<a href="<?php echo $g5['url']?>/" class="logo"><img src="<?php echo $g5['tmpl_url']?>/images/logo.png" alt="<?php echo _t('로고'); ?>"></a>
			<?php } ?>
			<form name="fsearchbox" method="get" action="<?php echo G5_SHOP_URL ?>/search.php" onsubmit="return fsearchbox_submit(this);">
				<input type="text" name="q" id="search" onclick="javascript:this.focus();">
