...
<div id="ft">
    ...
    <?php } else { ?>
    <div id="ft_catch"><img src="<?php echo G5_TMPL_URL; ?>/images/ft.png" alt="<?php echo GB_VERSION ?>"></div>
    <?php } ?>
    <div id="ft_company">
    </div>
    <div id="ft_copy">
        <div>
            ...
            Copyright &copy; <b><?php echo _t($config['cf_title'])?></b>. <?php echo _t('All rights reserved.'); ?><br>
