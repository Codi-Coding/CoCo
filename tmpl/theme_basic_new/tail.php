...
<div id="ft">
    ...
    <div id="ft_wr">
        <div id="ft_link">
            ...
            <a href="<?php echo get_device_change_url(); ?>"><?php echo _t('모바일 버전으로 보기'); ?></a>
        </div>
        <div id="ft_catch"><img src="<?php echo G5_THEME_URL; ?>/img/ft_logo.png" alt="<?php echo $config['cf_title']; ?>"></div>
