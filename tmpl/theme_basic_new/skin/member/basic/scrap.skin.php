    ...
    <div class="list_01 new_win_con">
        <ul>
            ...
            <li>
                ...
                <a href="<?php echo $list[$i]['del_href'];  ?>" onclick="del(this.href); return false;" class="scrap_del"><i class="fa fa-times-circle" aria-hidden="true"></i><span class="sound_only"><?php echo _t('삭제'); ?></span></a>
            </li>
            <?php }  ?>

            <?php if ($i == 0) echo "<li class=\"empty_li\">"._t("자료가 없습니다.")."</li>";  ?>
        </ul>
    </div>
