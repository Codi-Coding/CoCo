...
<fieldset id="new_sch">
    ...
    <button type="submit" class="btn_submit"><i class="fa fa-search" aria-hidden="true"></i> <?php echo _t('검색'); ?></button>
...
<button type="submit" onclick="document.pressed=this.value" class="btn_b01 btn"><i class="fa fa-trash-o" aria-hidden="true"></i><span class="sound_only"><?php echo _t('선택삭제'); ?></span></button>
</div>
<?php } ?>
</form>
