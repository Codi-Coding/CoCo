...
<button type="button" class="cmt_btn"><i class="fa fa-commenting" aria-hidden="true"></i> <?php echo _t('댓글목록'); ?></button>
...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <header>
            <h2><?php echo get_text($list[$i]['wr_name']); ?><?php echo _t('님의 댓글'); ?><?php if ($cmt_depth) { ?><span class="sound_only"><?php echo _t('의 댓글'); ?></span><?php } ?></h2>
        ...
        <div class="cmt_contents">
            ...
            ?>
                <ul class="bo_vc_act">
                    ...
                    <?php if ($list[$i]['is_del'])  { ?><li><a href="<?php echo $list[$i]['del_link']; ?>" onclick="return comment_delete();"><?php echo _t('삭제'); ?></a></li><?php } ?>
                </ul>
            <?php } ?>
        </div>
...
<?php if ($is_comment_write) {
    ...
    <aside id="bo_vc_w">
        ...
        <?php if ($comment_min || $comment_max) { ?>onkeyup="check_byte('wr_content', 'char_count');"<?php } ?> placeholder="<?php echo _t('댓글내용을 입력해주세요'); ?>"><?php echo $c_wr_content; ?></textarea>
        ...
        <div class="bo_vc_w_wr">
            <div class="bo_vc_w_info">
                ...
                <span class="bo_vc_secret">
                    ...
                    <label for="wr_secret" class="icon_lock"><i class="fa fa-lock" aria-hidden="true"></i><span class="sound_only"><?php echo _t('비밀글사용'); ?></span></label>
                </span>
