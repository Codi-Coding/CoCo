...
<div id="memo_list" class="new_win">
    ...
    <ul class="win_ul">
        <li><a href="./memo.php?kind=recv" class="<?php if ($kind == 'recv') {  ?>selected<?php }  ?>"><?php echo _t('받은쪽지'); ?></a></li>
        <li><a href="./memo.php?kind=send" class="<?php if ($kind == 'send') {  ?>selected<?php }  ?>"><?php echo _t('보낸쪽지'); ?></a></li>
        ...
        <ul id="memo_list_ul">
            ...
            <li>
                ...
                <span class="memo_date">
                    <?php echo $list[$i]['send_datetime'] ?><span class="sound_only"> <?php echo _t('에'); ?> <?php echo  ($kind == "recv") ? _t("받은") : _t("보낸");  ?> <?php echo _t('쪽지'); ?></span> - 
