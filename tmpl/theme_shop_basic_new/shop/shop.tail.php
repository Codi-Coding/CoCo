...
<div id="ft">
    <div class="ft_wr">
        <ul class="ft_ul">
            ...
            <li><a href="<?php echo get_device_change_url(); ?>"><?php echo _t('모바일 버전으로 보기'); ?></a></li>
        </ul>
        
        <a href="<?php echo G5_SHOP_URL; ?>/" id="ft_logo"><img src="<?php echo G5_THEME_IMG_URL; ?>/shop_ft.png" alt="<?php echo _t('처음으로'); ?>"></a>
        ...
        <div class="ft_cs">
            <h2><?php echo _t('고객센터'); ?></h2>
            <strong>02-123-1234</strong>
            <p><?php echo _t('월-금 am 9:00 - pm 05:00'); ?><br><?php echo _t('점심시간 : am 12:00 - pm 01:00'); ?></p>
        </div>
        <button type="button" id="top_btn"><i class="fa fa-arrow-up" aria-hidden="true"></i><span class="sound_only"><?php echo _t('상단으로'); ?></span></button>
        <script>
