...
<header id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="gnb" class="hd_div">
            ...
            if ($i == 0) {  ?>
                <li id="gnb_empty"><?php echo _t('메뉴 준비 중입니다.'); ?><?php if ($is_admin) { ?> <br><a href="<?php echo G5_ADMIN_URL; ?>/menu_list.php"><?php echo _t('관리자모드'); ?> &gt; <?php echo _t('환경설정'); ?> &gt; <?php echo _t('메뉴설정'); ?></a><?php echo _t('에서 설정하세요.'); ?><?php } ?></li>
            <?php } ?>
                <li class="gnb_1dli"><a href="<?php echo G5_SHOP_URL ?>" class="gnb_1da"> <?php echo _t('쇼핑몰'); ?></a></li>
            </ul>
            ...
            <div id="hd_sch">
                ...
                <input type="text" name="stx" id="sch_stx" placeholder="<?php echo _t('검색어(필수)'); ?>" required maxlength="20">
        ...
        <div class="hd_div" id="user_menu">
            ...
            <ul id="hd_nb">
                ...
                <li class="hd_nb3"><a href="<?php echo G5_BBS_URL ?>/current_connect.php" id="snb_cnt"><i class="fa fa-users" aria-hidden="true"></i><br><?php echo _t('접속자'); ?> <span><?php echo connect('theme/basic'); // 현재 접속자수 ?></span></a></li>
