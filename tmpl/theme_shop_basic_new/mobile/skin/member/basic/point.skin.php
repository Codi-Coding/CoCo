    ...
    //            if($row['po_expired'] == 1)
            ...
            <li>
                <div class="point_wrap01">
                    ...
                    <span class="point_date"><?php echo conv_date_format('y-m-d H'._t('시'), $row['po_datetime']); ?></span>
                </div>
            ...
            if ($i == 0)
                echo '<li class="empty_list">'._t('자료가 없습니다.').'</li>';
            else {
                if ($sum_point1 > 0)
        ...
        <div id="point_sum">
            <div class="sum_row">
                <span class="sum_tit"><?php echo _t('지급'); ?></span>
                <b class="sum_val"><?php echo $sum_point1; ?></b>
            </div>
            <div class="sum_row">
                <span class="sum_tit"><?php echo _t('사용'); ?></span>
                <b class="sum_val"><?php echo $sum_point2; ?></b>
            </div>
            <div class="sum_row">
                <span class="sum_tit"><?php echo _t('보유'); ?></span>
        ...
        <div class="win_btn"><button type="button" onclick="javascript:window.close();" class="btn_close"><?php echo _t('창닫기'); ?></button></div>
    </div>
</div>
