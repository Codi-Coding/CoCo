        ...
        <section id="poll_result_cmt">
            ...
            <article>
                <header>
                    ...
                    <span class="poll_cmt_del"><?php if ($list2[$i]['del']) { echo $list2[$i]['del']."<i class=\"fa fa-times-circle\" aria-hidden=\"true\"></i><span class=\"sound_only\">"._t("삭제")."</span></a>"; } ?></span></span>
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <?php if ($is_guest) { ?>
                <tr>
                    <td><input type="text" name="pc_name" id="pc_name" class="frm_input full_input required" required placeholder="<?php echo _t('이름(필수)'); ?>"></td>
                </tr>
                <?php } ?>
                <tr>
                    <td><input type="text" name="pc_idea" id="pc_idea" class="frm_input full_input required" required maxlength="100" placeholder="<?php echo _t('의견(필수)'); ?>"></td>
                </tr>
                <?php if ($is_guest) { ?>
                <tr>
