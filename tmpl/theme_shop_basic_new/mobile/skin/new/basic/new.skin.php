...
<fieldset id="new_sch">
    ...
    <input type="text" name="mb_id" value="<?php echo $mb_id ?>" id="mb_id" placeholder="<?php echo _t('검색어(필수)'); ?>" required class="frm_input ">
    <button type="submit" value="<?php echo _t('검색'); ?>" class="btn_submit"><i class="fa fa-search" aria-hidden="true"></i></button>
    </form>
    <script>
...
<div class="list_01" id="new_list">
    ...
    <?php if ($i == 0)
        echo '<li class="empty_table">'._t('게시물이 없습니다.').'</li>';
    ?>
    </ul>
</div>
