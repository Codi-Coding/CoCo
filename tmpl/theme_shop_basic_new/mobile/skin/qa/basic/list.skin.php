...
<div id="bo_list">
    ...
    <ul class="btn_top top">
        ...
        <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02"><i class="fa fa-pencil" aria-hidden="true"></i> <?php echo _t('문의등록'); ?></a></li><?php } ?>
    </ul>
    <?php } ?>
    ...
    <div id="list_chk">
        ...
        <label for="chkall"><?php echo _t('게시물 전체').' '._t('선택'); ?></label>
    </div>
    <?php } ?>
        ...
        <ul>
            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                ...
                <div class="li_info">
                    ...
                    <div class="li_stat <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($list[$i]['qa_status'] ? '<i class="fa fa-check-circle" aria-hidden="true"></i> '._t('답변완료') : '<i class="fa fa-times-circle" aria-hidden="true"></i> '._t('답변대기')); ?></div>
            ...
            <?php if ($i == 0) { echo '<li class="empty_list">'._t('게시물이 없습니다.').'</li>'; } ?>
        </ul>
    </div>
