...
<header id="hd">
    ...
    <div id="hd_wr">
        <div id="logo"><a href="<?php echo G5_SHOP_URL; ?>/"><img src="<?php echo G5_THEME_IMG_URL; ?>/shop_logo.png" alt="<?php echo $config['cf_title']; ?> <?php echo _t('메인'); ?>"></a></div>
        <div id="hd_btn">
            <button type="button" id="btn_hdcate"><i class="fa fa-bars" aria-hidden="true"></i><span class="sound_only"><?php echo _t('분류'); ?></span></button>
            <a href="<?php echo G5_SHOP_URL; ?>/cart.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="sound_only"><?php echo _t('장바구니'); ?></span><span class="cart-count"><?php echo get_boxcart_datas_count(); ?></span></a>
