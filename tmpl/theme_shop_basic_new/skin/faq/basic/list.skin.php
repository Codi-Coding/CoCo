...
if ($admin_href)
    echo '<div class="faq_admin"><a href="'.$admin_href.'" class="btn_admin btn">'._t('FAQ 수정').'</a></div>';
?>
...
<fieldset id="faq_sch">
    ...
    <span class="sch_tit"><?php echo _t('FAQ 검색'); ?></span>
    ...
    <button type="submit" value="검색" class="btn_submit"><i class="fa fa-search" aria-hidden="true"></i> <?php echo _t('검색'); ?></button>
    </form>
</fieldset>
