...
<section id="visit">
    ...
    <dl>
        <dt><i class="fa fa-user-o" aria-hidden="true"></i> <?php echo _t('오늘'); ?></dt>
        <dd><?php echo number_format($visit[1]) ?></dd>
        <dt><i class="fa fa-user-o" aria-hidden="true"></i> <?php echo _t('어제'); ?></dt>
        <dd><?php echo number_format($visit[2]) ?></dd>
        <dt><i class="fa fa-user-o" aria-hidden="true"></i> <?php echo _t('최대'); ?></dt>
        <dd><?php echo number_format($visit[3]) ?></dd>
        <dt><i class="fa fa-user-o" aria-hidden="true"></i> <?php echo _t('전체'); ?></dt>
