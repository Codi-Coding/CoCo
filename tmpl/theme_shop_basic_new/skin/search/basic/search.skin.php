...
<div id="sch_result">
    ...
    <section id="sch_res_ov">
        <h2><strong><?php echo $stx ?></strong> <?php echo _t('전체검색 결과'); ?></h2>
        <dl>
            <dt><?php echo _t('게시판'); ?></dt>
            <dd><strong class="sch_word"><?php echo $board_count ?><?php echo _t('개'); ?></strong></dd>
            <dt><?php echo _t('게시물'); ?></dt>
            <dd><strong class="sch_word"><?php echo number_format($total_count) ?><?php echo _t('개'); ?></strong></dd>
        </dl>
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
         ...
         ?>
            ...
            <li>
                <div class="sch_tit">
                    ...
                    <a href="<?php echo $list[$idx][$i]['href'] ?><?php echo $comment_href ?>" target="_blank" class="pop_a"><i class="fa fa-share-square-o" aria-hidden="true"></i><?php echo _t('새창'); ?></a>
                </div>
        ...
        <div class="sch_more"><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;<?php echo $search_query ?>"><strong><i class="fa fa-plus-circle" aria-hidden="true"></i> <?php echo _t($bo_subject[$idx]) ?></strong> <?php echo _t('결과 더보기'); ?></a></div>
