...
<!-- 회원가입결과 시작 { -->
<div id="reg_result">
    <h2><?php echo _t('회원가입이 완료되었습니다.'); ?></h2>
    ...
    <p>
        ...
        <?php echo _t('발송된 인증메일을 확인하신 후 인증처리를 하시면 사이트를 원활하게 이용하실 수 있습니다.'); ?>
    </p>
    <div id="result_email">
    ...
    <p>
        ...
        <?php echo _t('아이디, 비밀번호 분실시에는 회원가입시 입력하신 이메일 주소를 이용하여 찾을 수 있습니다.'); ?>
    </p>
    ...
    <p>
        ...
        <a href="<?php echo G5_URL ?>/" class="btn_submit"><?php echo _t('메인으로'); ?></a>
