...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h1 id="bo_v_title">
            <?php
            if ($category_name) echo _t($view['ca_name']).' | '; // 분류 출력 끝
            echo cut_str(get_text(_t($view['wr_subject'])), 70); // 글제목 출력
            ?>
        </h1>
        <?php if($view[wr_1] == "1") { ?>
	<span style="float:right">
        &nbsp;&nbsp;<font color=ff6600>[<?php echo _t('팝업'); ?>]</font>
           <?php if($view[wr_2] == "") { ?><font color=ff6600>[<?php echo _t('이미지만'); ?>]</font>
           <?php } else if($view[wr_2] == "1") { ?><font color=ff6600>[<?php echo _t('제목+이미지'); ?>]</font>
           <?php } else if($view[wr_2] == "2") { ?><font color=ff6600>[<?php echo _t('제목+텍스트'); ?>]</font>
           <?php } else if($view[wr_2] == "3") { ?><font color=ff6600>[<?php echo _t('제목+이미지+텍스트'); ?>]</font>
           <?php } ?>
	</span>
        <?php } ?>
    </header>
