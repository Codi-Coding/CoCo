...
<section id="sch_all_aside">
    <div>
        ...
        <form name="fsearchbox" action="<?php echo G5_BBS_URL; ?>/search_all.php" onsubmit="return search_submit(this);">
	<input type=radio name=bbs_search value=0<?php if(!$bbs_search && !$sfl) echo ' checked'; else echo ''; ?>><?php echo _t('상품'); ?>
