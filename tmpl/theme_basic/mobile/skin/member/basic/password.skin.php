...
<div id="pw_confirm" class="mbskin">
    ...
    <p>
        ...
        <?php echo _t('작성자와 관리자만 열람하실 수 있습니다. 본인이라면 비밀번호를 입력하세요.'); ?>
        <?php } ?>
    </p>
    ...
    <fieldset>
        <input type="password" name="wr_password" id="pw_wr_password"  placeholder="<?php echo _t('비밀번호(필수)'); ?>" required class="frm_input required" maxLength="20">
        <input type="submit" class="btn_submit" value="<?php echo _t('확인'); ?>">
    </fieldset>
    </form>

    <div class="btn_confirm">
        <a href="<?php echo $return_url ?>"><?php echo _t('돌아가기'); ?></a>
    </div>
