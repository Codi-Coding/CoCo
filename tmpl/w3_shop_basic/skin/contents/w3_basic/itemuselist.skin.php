    ...
    <li>
        ...
        <div class="sps_img">
            <a href="<?php echo $it_href; ?>">
                <?php echo cm_get_itemuselist_thumbnail($row['it_id'], $row['is_content'], 70, 70); ?>
        ...
        <section class="sps_section">
            ...
            <dl class="sps_dl">
                ...
                <dd><img src="<?php echo G5_CONTENTS_URL; ?>/img/s_star<?php echo $star; ?>.png" alt="별<?php echo $star; ?>개"></dd>
            </dl>
