...
<section id="cit_qa_list" class="cit_ol">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        $is_secret = false;
        if($row['iq_secret']) {
            $iq_subject .= ' <img src="'.G5_CONTENTS_SKIN_URL.'/img/icon_secret.gif" alt="'._t('비밀글').'">';
        ...
        if ($i == 0) echo '<ol id="cit_qa_ol" class="cit_ol">';
    ?>

        <li class="cit_qa_li">
            <button type="button" class="cit_qa_li_title"><b><?php echo $iq_num; ?>.</b> <?php echo $iq_subject; ?></button>
            <dl class="cit_qa_dl">
            ...
            <div id="cit_qa_con_<?php echo $i; ?>" class="cit_qa_con">
                <div class="cit_qa_p">
    ...
    if (!$i) echo '<p class="cit_empty">'._t('상품문의가 없습니다.').'</p>';
    ?>
</section>
