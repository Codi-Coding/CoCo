...
<div id="cqa_sch">
    ...
    <select name="sfl" id="sfl" required class="required">
        ...
        <option value="a.iq_subject" <?php echo get_selected($sfl, "a.is_subject"); ?>><?php echo _t('문의제목'); ?></option>
...
<div id="cqa">
    ...
    <li>
        ...
        <section class="cqa_section">
            ...
            <div class="cqa_con_btn"><button class="cqa_con_<?php echo $i; ?>"><?php echo _t('보기'); ?></button></div>
        </section>
    ...
    if ($i > 0) echo '</ol>';
    if ($i == 0) echo '<p id="cqa_empty">'._t('자료가 없습니다.').'</p>';
    ?>
</div>
...
$(function(){
    ...
    $(".cqa_con_btn button").click(function(){
        ...
        if($con.is(":visible")) {
            ...
            $(".cqa_con_btn button").text("<?php echo _t('보기'); ?>");
