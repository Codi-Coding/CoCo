...
$list_skin = 'webzine'; /// blog, gallery, webzine
if($list_skin) { include $board_skin_path.'/list.skin.'.$list_skin.'.php'; return; }
...
<div id="bo_list<?php if ($is_admin) echo "_admin"; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col"><?php echo _t('제목'); ?>
            <span class="sort_link">
