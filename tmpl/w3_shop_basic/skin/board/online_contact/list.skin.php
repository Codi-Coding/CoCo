...
<?php 
if (0 && !$is_admin) goto_url(G5_HTTP_BBS_URL.'/write.php?bo_table='.$bo_table.$qstr);
?>
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col"><?php echo _t('내용'); ?></th>
            <th scope="col"><?php echo _t('상태'); ?></th>
            <th scope="col"><?php echo _t('이름') ;?></th>
            <th scope="col"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?><?php echo _t('날짜'); ?></a></th>
            <!--<th scope="col"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?><?php echo _t('조회'); ?></a></th>-->
            <?php if ($is_good) { ?><th scope="col"><?php echo subject_sort_link('wr_good', $qstr2, 1) ?><?php echo _t('추천'); ?></a></th><?php } ?>
            <?php if ($is_nogood) { ?><th scope="col"><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?><?php echo _t('비추천'); ?></a></th><?php } ?>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>">
                    ...
                    <?php echo substr($list[$i]['wr_content'], 0, 60) ?>
            ...
            <td class="td_name"><?php echo _t($list[$i]['wr_1']); ?></td>
...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl">
        ...
        <option value="wr_1"<?php echo get_selected($sfl, 'wr_1', true); ?>><?php echo _t('상태'); ?></option>
    </select>
