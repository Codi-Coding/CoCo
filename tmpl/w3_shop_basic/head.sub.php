...
<link rel="stylesheet" href="<?php echo G5_THEME_CSS_URL; ?>/w3.4.css">
<?php
add_stylesheet ('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/w3-theme-black.css">', 0);
add_stylesheet ('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">', 0);
?>
<?php
$shop_css = '';
if (defined('_SHOP_')) $shop_css = '_shop';
else if (defined('_CONTENTS_')) $shop_css = '_contents';
add_stylesheet ('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/'.(G5_IS_MOBILE?'mobile':'default').$shop_css.'.css?ver='.G5_CSS_VER.'">', 0);
add_stylesheet ('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/'.'style.css?ver='.G5_CSS_VER.'">', 0);
?>
<!--[if lte IE 8]>
...
<body id="myPage"<?php echo isset($g5['body_script']) ? $g5['body_script'] : ''; ?>>
