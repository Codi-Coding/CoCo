...
<tr class='ht2'>
    ...
    echo '$config2w = ';
    var_export(array_slice($config2w_org, 1));
    echo ';'.PHP_EOL;
    echo '$config2w_config = ';
    var_export(array_slice($config2w_config, 1));
    echo ';'.PHP_EOL;
    echo '$config2w_board_all = ';
    var_export(array_slice($config2w_board_all, 0));
    echo ';'.PHP_EOL;
    echo '$config2w_menu = ';
    var_export(array_slice($config2w_menu, 0));
    echo ';'.PHP_EOL;
    echo '$config2w_m_def = ';
    var_export(array_slice($config2w_m_def, 1));
    echo ';';
    ?></textarea>
    </td>
</tr>
