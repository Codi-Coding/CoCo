...
$sql_common = " from {$g5['config2w_board_table']} ";
///$sql_search = " where (cf_id='{$config2w_def['cf_templete']}') ";
$sql_search = " where (cf_id='{$g5['tmpl']}') ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td>
            ...
            <?php echo get_tmpl_skin_select('board', 'bo_skin_'.$i, "bo_skin[$i]", $row['bo_skin']); ?>
        </td>
    </tr>
    <?php
    }
