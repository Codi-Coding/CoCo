...
<div class="tbl_head02 tbl_wrap">
    ...
    <thead>
    <tr>
        <th scope="col" rowspan="1" id="mb_list_id"><?php echo subject_sort_link('mb_id') ?>아이디</a></th>
        <th scope="col" id="mb_list_name"><?php echo subject_sort_link('mb_name') ?>이름</a></th>
        <th scope="col" rowspan="1" id="mb_list_mng">관리</th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr class="<?php echo $bg; ?>">
        <td headers="mb_list_id" rowspan="1" class="td_name sv_use"><?php echo $mb_id ?></td>
        <td headers="mb_list_name" class="td_mbname"><?php echo get_text($row['mb_name']); ?></td>
        <td headers="mb_list_mng" rowspan="1" class="td_mngsmall"><?php echo $s_mod ?></td>
    </tr>
