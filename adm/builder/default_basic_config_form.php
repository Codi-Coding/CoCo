...
<tr class='ht2'>
	<td>헤더 로고명</td>
	<td valign=middle><input type=text class="frm_input" size='15' name='cf_header_logo' value='<?php echo $config2w['cf_header_logo']?>'> <?php echo help("페이지 상단 좌측의 헤더 로고명을 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>사이트 이름</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_site_name' value='<?php echo $config2w['cf_site_name']?>'> 
...
<tr class='ht2'>
	<td>사이트 주소</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_site_addr' value='<?php echo $config2w['cf_site_addr']?>'> <?php echo help("페이지 하단의 사이트 주소를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>우편 번호</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_zip' value='<?php echo $config2w['cf_zip']?>'> <?php echo help("페이지 하단의 우편 번호를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>전화 번호</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_tel' value='<?php echo $config2w['cf_tel']?>'> <?php echo help("페이지 하단의 전화 번호를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>팩스</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_fax' value='<?php echo $config2w['cf_fax']?>'> <?php echo help("페이지 하단의 팩스 번호를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>이메일</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_email' value='<?php echo $config2w['cf_email']?>'> <?php echo help("페이지 하단의 이메일 주소를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>대표</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_site_owner' value='<?php echo $config2w['cf_site_owner']?>'> <?php echo help("페이지 하단의 대표를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>사업자 등록 번호</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_biz_num' value='<?php echo $config2w['cf_biz_num']?>'> <?php echo help("페이지 하단의 사업자 등록 번호를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>통신 판매업 신고 번호</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_ebiz_num' value='<?php echo $config2w['cf_ebiz_num']?>'> <?php echo help("페이지 하단의 통신 판매업 신고 번호를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>개인 정보 관리 책임자</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_info_man' value='<?php echo $config2w['cf_info_man']?>'> <?php echo help("페이지 하단의 개인 정보 관리 책임자를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>개인 정보 관리 책임자 이메일</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_info_email' value='<?php echo $config2w['cf_info_email']?>'> <?php echo help("페이지 하단의 개인 정보 관리 책임자 이메일을 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>저작권 명시</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_copyright' value='<?php echo $config2w['cf_copyright']?>'> <?php echo help("페이지 하단의 저작권 표시를 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>Keywords</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_keywords' value='<?php echo $config2w['cf_keywords']?>'> <?php echo help("HTML 페이지 내의 meta keywords로 사용될 키워드들을 입력하십시요.")?></td>
</tr>
<tr class='ht2'>
	<td>Description</td>
	<td valign=middle><input type=text class="frm_input" size='40' name='cf_description' value='<?php echo $config2w['cf_description']?>'> <?php echo help("HTML 페이지 내의 meta description으로 사용될 페이지 소개 내용을 입력하십시요.")?></td>
</tr>
</table>
</section>
-->
