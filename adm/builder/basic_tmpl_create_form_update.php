...
/// config2w_config
$sql = " select * from $g5[config2w_config_table] where cf_id='$cf_id' ";
$row = sql_fetch($sql);
...
/// config2w_board
$sql = " select * from $g5[config2w_board_table] where cf_id='$cf_id' ";
$row = sql_fetch($sql);
...
/// config2w_menu
$sql = " select * from $g5[config2w_menu_table] where cf_menu='$cf_id' ";
$row = sql_fetch($sql);
...
/// config2w_m_def
$sql = " select * from $g5[config2w_m_def_table] where cf_templete = '$cf_id' ";
$row = sql_fetch($sql);
