...
<div id="ins_bar">
    ...
    <span id="bar_txt">SHOP INSTALLATION</span>
</div>

<?php
// 파일이 존재한다면 설치할 수 없다.
///$dbconfig_file = $data_path.'/'.G5_DBCONFIG_FILE;
$dbconfig_file = '../../../../data/shop.dbconfig.php';
if (file_exists($dbconfig_file)) {
?>
<h1>쇼핑몰 프로그램이 이미 설치되어 있습니다.</h1>
...
{
?>
<h1>쇼핑몰 설치를 위해 아래 내용을 확인해 주십시오.</h1>
