...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		...
		<td>
			<label><input type="checkbox" name="wset[fix]" value="1"<?php echo get_checked('1', $wset['fix']); ?>> 모바일(480px)에서도 스타일 유지</label>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			출력
			&nbsp;
			<input type="text" name="wset[size]" value="<?php echo $wset['size']; ?>" class="frm_input" size="4"> px 너비(기본 125)
			&nbsp;
			<input type="text" name="wset[line]" value="<?php echo $wset['line']; ?>" class="frm_input" size="4"> 줄(기본 1)
			&nbsp;
			<label><input type="checkbox" name="wset[right]" value="1"<?php echo get_checked('1', $wset['right']);?>> 우측</label>
		</td>
	</tr>
	<tr>
		<td>
