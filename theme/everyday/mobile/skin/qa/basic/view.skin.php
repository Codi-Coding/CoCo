...
<article id="bo_v">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?><li class="btn_prev"><a href="<?php echo $prev_href ?>" class="box btn_hover"><i class="fa fa-angle-left" aria-hidden="true"></i> 이전글</a></li><?php } ?>
            <?php if ($next_href) { ?><li class="btn_next"><a href="<?php echo $next_href ?>" class="box btn_hover">다음글 <i class="fa fa-angle-right" aria-hidden="true"></i></a></li><?php } ?>
        </ul>
        <?php } ?>
