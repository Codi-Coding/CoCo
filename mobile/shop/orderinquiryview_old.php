        ...
        <ul id="sod_list_inq" class="sod_list">
            ...
            ?>
                ...
                <div class="li_prqty">
                    ...
                    <span class="prqty_stat li_prqty_sp"><span><?php echo _t('상태'); ?> </span><?php echo _t($opt['ct_status']); ?></span>
                </div>
                <div class="li_total" style="padding-left:<?php echo $image_width + 10; ?>px;height:auto !important;height:<?php echo $image_height; ?>px;min-height:<?php echo $image_height; ?>px">
                    ...
                    <span class="total_point total_span"><span><?php echo _t('적립포인트'); ?> </span><?php echo number_format(_cc($point), $g5['decimal_point']); ?></span>
                </div>
            <?php
                    $tot_point       += $point;
    ...
    <div id="sod_fin_view">
        ...
        <section id="sod_fin_orderer">
            ...
            <div  class="odf_tbl">
                ...
                <tbody>
                <tr>
                    <th scope="row"><?php echo _t('이름'); ?></th>
