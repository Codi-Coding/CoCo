...
if($g5['is_db_trans'] && file_exists($g5['locale_path'].'/include/ml/mobile/shop'.'/mypage.ml.php')) { include_once $g5['locale_path'].'/include/ml/mobile/shop'.'/mypage.ml.php'; return; }

if(defined('G5_USE_OLD_CODE') && G5_USE_OLD_CODE) { include_once G5_MSHOP_PATH.'/mypage_old.php'; return; }
...
<div id="smb_my">
    ...
    <section id="smb_my_ov">
        ...
        <div class="my_name">
            <img src="<?php echo G5_THEME_IMG_URL ;?>/no_profile.gif" alt="<?php echo _t('프로필이미지'); ?>" width="20"> <strong><?php echo $member['mb_id'] ? $member['mb_name'] : '비회원'; ?></strong><?php echo _t('님'); ?>
            <ul class="smb_my_act">
                <?php if ($is_admin == 'super') { ?><li><a href="<?php echo G5_ADMIN_URL; ?>/" class="btn_admin"><?php echo _t('관리자'); ?></a></li><?php } ?>
                <li><a href="<?php echo G5_BBS_URL; ?>/member_confirm.php?url=register_form.php" class="btn01"><?php echo _t('정보수정'); ?></a></li>
        ...
        <div class="my_info">
            <div class="my_info_wr">
                <strong><?php echo _t('연락처'); ?></strong>
                <span><?php echo ($member['mb_tel'] ? $member['mb_tel'] : _t('미등록')); ?></span>
            </div>
            <div class="my_info_wr">
                <strong><?php echo _t('E-Mail'); ?></strong>
                <span><?php echo ($member['mb_email'] ? $member['mb_email'] : _t('미등록')); ?></span>
            </div>
            <div class="my_info_wr">
                <strong><?php echo _t('최종접속일시'); ?></strong>
                <span><?php echo $member['mb_today_login']; ?></span>
             </div>
            <div class="my_info_wr">
            <strong><?php echo _t('회원가입일시'); ?></strong>
        ...
        <div class="my_ov_btn"><button type="button" class="btn_op_area"><i class="fa fa-caret-down" aria-hidden="true"></i><span class="sound_only"><?php echo _t('상세정보 보기'); ?></span></button></div>
    ...
    <section id="smb_my_od">
        ...
        ?>
        <a href="<?php echo G5_SHOP_URL; ?>/orderinquiry.php" class="btn_more"><?php echo _t('더보기'); ?></a>
    </section>
    ...
    <section id="smb_my_wish" class="wishlist">
        ...
        <ul>
         ...
         <a href="<?php echo G5_SHOP_URL; ?>/wishlist.php" class="btn_more"><?php echo _t('더보기'); ?></a>
    </section>
