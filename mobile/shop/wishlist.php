...
if($g5['is_db_trans'] && file_exists($g5['locale_path'].'/include/ml/mobile/shop'.'/wishlist.ml.php')) { include_once $g5['locale_path'].'/include/ml/mobile/shop'.'/wishlist.ml.php'; return; }

if(defined('G5_USE_OLD_CODE') && G5_USE_OLD_CODE) { include_once G5_MSHOP_PATH.'/wishlist_old.php'; return; }
...
<div id="sod_ws">
    ...
    ?>
        ...
        <li>
            ...
            <div class="wish_info">
                ...
                <div class="wish_chk">
                    ...
                    {
                    ?>
                    <span class="sold_out"><?php echo _t('품절'); ?></span>
                ...
                <span class="wish_del"><a href="<?php echo G5_SHOP_URL; ?>/wishupdate.php?w=d&amp;wi_id=<?php echo $row['wi_id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i><span class="sound_only"><?php echo _t('삭제'); ?></span></a></span>
            </div>
        ...
        if ($i == 0)
            echo '<li class="empty_table">'._t('위시리스트가 비었습니다.').'</li>';
        ?>
    </ul>

    
    <div id="sod_ws_act">
        <button type="submit" class="btn02" onclick="return fwishlist_check(document.fwishlist,'direct_buy');"><?php echo _t('바로구매'); ?></button>
        <button type="submit" class="btn01" onclick="return fwishlist_check(document.fwishlist,'');"><?php echo _t('장바구니'); ?></button>
