...
if(defined('G5_USE_OLD_CODE') && G5_USE_OLD_CODE) { include_once G5_MSHOP_PATH.'/orderform.sub_old.php'; return; }
        ...
        <li class="sod_li">
            ...
            <div class="li_prqty">
                ...
                <span class="prqty_sc li_prqty_sp"><span><?php echo _t('배송비'); ?> </span><?php echo number_format(_cc($ct_send_cost), $g5['decimal_point']); ?></span>
                 <span class="total_point li_prqty_sp"><span><?php echo _t('적립포인트'); ?> </span><strong><?php echo number_format($sum['point']); ?></strong></span>

            </div>
            <div class="total_price total_span"><span><?php echo _t('주문금액'); ?> </span><strong><?php echo number_format(_cc($sell_price), $g5['decimal_point']); ?></strong></div>
...
<div id="sod_frm">
    ...
    <section id="sod_frm_orderer" >
        ...
        <div class="odf_list">
            <ul>
                <li>
                    <label for="od_name"><?php echo _t('이름'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label>
                ...
                <li>
                    <label for="od_pwd"><?php echo _t('비밀번호'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label>
                ...
                <li>
                    <label for="od_tel"><?php echo _t('전화번호'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label>
                ...
                <li>
                    <label for="od_hp"><?php echo _t('핸드폰'); ?></label>
                    <input type="text" name="od_hp" value="<?php echo get_text($member['mb_hp']); ?>" id="od_hp" class="frm_input" maxlength="20">
                </li>
                <li>
                    <strong><?php echo _t('주소'); ?></strong>
                    
                    <span class="add_num"><label for="od_zip" class="sound_only"><?php echo _t('우편번호'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label>
                    ...
                    <button type="button" class="btn_frmline btn_addsch" onclick="win_zip('forderform', 'od_zip', 'od_addr1', 'od_addr2', 'od_addr3', 'od_addr_jibeon');"><?php echo _t('주소검색'); ?></button></span>
                ...
                <li>
                    <label for="od_email"><?php echo _t('E-mail'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label>
    ...
    <section id="sod_frm_taker">
        ...
        <div class="odf_list">
            <ul>
                ...
                ?>
                <li class="dlv_slt">
                    <strong><?php echo _t('배송지선택'); ?></strong>
                    <div><?php echo $addr_list; ?></div>
                </li>
                <?php if($is_member) { ?>
                <li>
                    <label for="ad_subject"><?php echo _t('배송지명'); ?></label>
                    <input type="text" name="ad_subject" id="ad_subject" class="frm_input" maxlength="20">
                    <input type="checkbox" name="ad_default" id="ad_default" value="1">
                    <label for="ad_default" class="ad_default"><?php echo _t('기본배송지로 설정'); ?></label>
                ...
                ?>
                <li>
                    <label for="od_b_name"><?php echo _t('이름'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label>
                    <input type="text" name="od_b_name" id="od_b_name" required class="frm_input required" maxlength="20">
                </li>
                <li>
                    <label for="od_b_tel"><?php echo _t('전화번호'); ?><strong class="sound_only"> <?php echo _t('필수'); ?></strong></label>
                    <input type="text" name="od_b_tel" id="od_b_tel" required class="frm_input required" maxlength="20">
                </li>
                <li>
                    <label for="od_b_hp"><?php echo _t('핸드폰'); ?></label>
                ...
                <li>
                    ...
                    <button type="button" class="btn_frmline  btn_addsch" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');"><?php echo _t('주소 검색'); ?></button></span>
                ...
                <li>
                    <label for="od_memo"><?php echo _t('전하실 말씀'); ?></label>
    ...
    <section id="sod_frm_pay">
        ...
        <div class="odf_tbl">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" id="od_coupon_btn" class="cp_btn1"><?php echo _t('쿠폰적용'); ?></button>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" id="sc_coupon_btn" class="cp_btn1"><?php echo _t('쿠폰적용'); ?></button>
                </td>
            </tr>
            <tr>
        ...
        if ($default['de_bank_use']) {
            $multi_settle++;
            echo '<li><input type="radio" id="od_settle_bank" name="od_settle_case" value="무통장" '.$checked.'> <label for="od_settle_bank" class="lb_icon  bank_icon">'._t('무통장입금').'</label></li>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($default['de_vbank_use']) {
            $multi_settle++;
            echo '<li><input type="radio" id="od_settle_vbank" name="od_settle_case" value="가상계좌" '.$checked.'> <label for="od_settle_vbank" class="lb_icon vbank_icon">'.$escrow_title._t('가상계좌').'</label></li>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($default['de_iche_use']) {
            $multi_settle++;
            echo '<li><input type="radio" id="od_settle_iche" name="od_settle_case" value="계좌이체" '.$checked.'> <label for="od_settle_iche" class="lb_icon iche_icon">'.$escrow_title._t('계좌이체').'</label></li>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($default['de_hp_use']) {
            $multi_settle++;
            echo '<li><input type="radio" id="od_settle_hp" name="od_settle_case" value="휴대폰" '.$checked.'> <label for="od_settle_hp" class="lb_icon hp_icon">'._t('휴대폰').'</label></li>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($default['de_card_use']) {
            $multi_settle++;
            echo '<li><input type="radio" id="od_settle_card" name="od_settle_case" value="신용카드" '.$checked.'> <label for="od_settle_card" class="lb_icon card_icon">'._t('신용카드').'</label></li>'.PHP_EOL;
            $checked = '';
        }
        ...
        if($default['de_samsung_pay_use']) {
            echo '<li><input type="radio" id="od_settle_samsungpay" data-case="samsungpay" name="od_settle_case" value="삼성페이" '.$checked.'> <label for="od_settle_samsungpay" class="samsung_pay lb_icon">'._t('삼성페이').'</label></li>'.PHP_EOL;
            $checked = '';
        }
        ...
        if ($is_member && $config['cf_use_point'])
        {
            ...
            if ($member['mb_point'] >= $default['de_settle_min_point'])
            {
                ...
                echo '<div><input type="hidden" name="max_temp_point" value="'.$temp_point.'"><label for="od_temp_point">'._t('사용 포인트').'('.$point_unit._t('점').' '._t('단위').')</label> <input type="text" id="od_temp_point" name="od_temp_point" value="0" size="10"> '._t('점').'</div>';
                echo '<div id="sod_frm_pt_info"><span><strong>'._t('보유포인트').'</strong>'.display_point($member['mb_point']).'</span><span class="max_point_box"><strong>'._t('최대사용가능포인트').'</strong><em id="use_max_point">'.display_point($temp_point).'</em></span></div>';
                echo '</div>';
                $multi_settle++;
            }
        }
...
$(function() {
    ...
    $(document).on("click", ".cp_apply", function() {
        ...
        $("#cp_frm").remove();
        $cp_btn_el.text("<?php echo _t('변경'); ?>").addClass("cp_mod").focus();
    ...
    $(document).on("click", ".od_cp_apply", function() {
        ...
        if(!$("#od_coupon_cancel").size())
            $("#od_coupon_btn").after("<button type=\"button\" id=\"od_coupon_cancel\" class=\"cp_cancel1\"><?php echo _t('취소'); ?></button>");
    });
    ...
    $(document).on("click", ".sc_cp_apply", function() {
        ...
        if(!$("#sc_coupon_cancel").size())
            $("#sc_coupon_btn").after("<button type=\"button\" id=\"sc_coupon_cancel\" class=\"cp_cancel1\"><?php echo _t('취소'); ?></button>");
    });
