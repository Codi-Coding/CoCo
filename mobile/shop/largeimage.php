...
if($g5['is_db_trans'] && file_exists($g5['locale_path'].'/include/ml/mobile/shop'.'/largeimage.ml.php')) { include_once $g5['locale_path'].'/include/ml/mobile/shop'.'/largeimage.ml.php'; return; }

if(defined('G5_USE_OLD_CODE') && G5_USE_OLD_CODE) { include_once G5_MSHOP_PATH.'/largeimage_old.php'; return; }
