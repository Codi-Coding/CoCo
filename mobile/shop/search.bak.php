...
if($g5['is_db_trans'] && file_exists($g5['locale_path'].'/include/ml/mobile/shop'.'/search.ml.php')) { include_once $g5['locale_path'].'/include/ml/mobile/shop'.'/search.ml.php'; return; }
