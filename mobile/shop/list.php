...
if($g5['is_db_trans'] && file_exists($g5['locale_path'].'/include/ml/mobile/shop'.'/list.ml.php')) { include_once $g5['locale_path'].'/include/ml/mobile/shop'.'/list.ml.php'; return; }

if(defined('G5_USE_OLD_CODE') && G5_USE_OLD_CODE) { include_once G5_MSHOP_PATH.'/list_old.php'; return; }
...
<div id="sct">
    ...
    ?>
    <div class="li_more">
        <p id="item_load_msg"><img src="<?php echo G5_SHOP_CSS_URL; ?>/img/loading.gif" alt="<?php echo _t('로딩이미지'); ?>" ><br><?php echo _t('잠시만 기다려주세요.'); ?></p>
        <div class="li_more_btn">
            <button type="button" id="btn_more_item" data-url="<?php echo $ajax_url; ?>" data-page="<?php echo $page; ?>"><?php echo _t('더보기'); ?> +</button>
        </div>
    </div>
    <?php } ?>
