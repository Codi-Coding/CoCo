    ...
    <ul>
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
            ...
            $sql = " select it_name, ct_option
                        ...
                        limit 1 ";
            $ct = sql_fetch($sql);
            $ct_name = get_text(_t($ct['it_name'])).' '.get_text(_t($ct['ct_option']));
        ...
        <li>
            ...
            <div class="inquiry_inv">
                <?php echo $od_invoice; ?>
                <span class="inv_status"><?php echo _t($od_status); ?></span>
            </div>
        </li>
        ...
        if ($i == 0)
            echo '<li class="empty_list">'._t('주문 내역이 없습니다.').'</li>';
        ?>
    </ul>
</div>
