...
if($g5['is_db_trans'] && file_exists($g5['locale_path'].'/include/ml/mobile/shop'.'/iteminfo.ml.php')) { include_once $g5['locale_path'].'/include/ml/mobile/shop'.'/iteminfo.ml.php'; return; }

if(defined('G5_USE_OLD_CODE') && G5_USE_OLD_CODE) { include_once G5_MSHOP_PATH.'/iteminfo_old.php'; return; }
...
<div class="close_btn"><button type="button" id="iteminfo_close" onclick="self.close();"><?php echo _t('창닫기'); ?></button></div>
