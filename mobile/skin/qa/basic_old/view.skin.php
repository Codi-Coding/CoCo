...
<!-- 게시물 읽기 시작 { -->
<div id="bo_v_table"><?php echo _t($qaconfig['qa_title']); ?></div>

<article id="bo_v">
    <header>
        <h1 id="bo_v_title">
            <?php
            echo _t($view['category']).' | '; // 분류 출력 끝
            echo _t($view['subject']); // 글제목 출력
            ?>
        </h1>
    </header>
    ...
    <section id="bo_v_info">
        ...
        <?php echo _t('작성자'); ?> <strong><?php echo $view['name'] ?></strong>
        <span class="sound_only"><?php echo _t('작성일'); ?></span><strong><?php echo $view['datetime']; ?></strong>
    </section>
    ...
    <section id="bo_v_rel">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                ...
                <td class="td_stat <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($rel_list[$i]['qa_status'] ? _t('답변완료') : _t('답변대기')); ?></td>
