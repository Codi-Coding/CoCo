...
<div id="sit_use_write" class="new_win">
    ...
    <div class="form_01">
        ...
        <ul>
            <li>
                <label for="is_subject" class="sound_only"><?php echo _t('제목'); ?></label>
                <input type="text" name="is_subject" value="<?php echo get_text($use['is_subject']); ?>" id="is_subject" required class="required frm_input" minlength="2" maxlength="250" placeholder="<?php echo _t('제목'); ?>">
            </li>
            <li>
            ...
            <li>
                ...
                <ul id="sit_use_write_star">
                    ...
                    <li>
                        ...
                        <label for="is_score8"><?php echo _t('만족'); ?></label>
                    ...
                    <li>
                        ...
                        <label for="is_score6"><?php echo _t('보통'); ?></label>
                    ...
                    <li>
                        ...
                        <label for="is_score4"><?php echo _t('불만'); ?></label>
                    ...
                    <li>
                        ...
                        <label for="is_score2"><?php echo _t('매우불만'); ?></label>
