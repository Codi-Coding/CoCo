...
<div id="sqa_sch">
    <div class="sch_wr">
        ...
        <select name="sfl" required id="sfl">
            ...
            <option value="a.iq_name"    <?php echo get_selected($sfl, "a.it_id"); ?>><?php echo _t('작성자명'); ?></option>
        ...
        <button type="submit" value="검색" class="sch_btn"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only"><?php echo _t('검색'); ?></span></button>
    </div>
...
<div id="sqa">
    ...
    <!-- <p><?php echo $config['cf_title']; ?> <?php echo _t('전체 상품문의 목록입니다.'); ?></p> -->
