...
<div id="ssch">
    ...
    <div id="ssch_frm">
        ...
        <div>
            ...
            <input type="checkbox" name="qname" id="ssch_qname" <?php echo $qname_check?'checked="checked"':'';?>> <label for="ssch_qname"><?php echo _t('상품명'); ?></label>
            <input type="checkbox" name="qexplan" id="ssch_qexplan" <?php echo $qexplan_check?'checked="checked"':'';?>> <label for="ssch_qexplan"><span class="sound_only"><?php echo _t('상품') ;?></span><?php echo _t('설명'); ?></label>
            ...
            <input type="checkbox" name="qid" id="ssch_qid" <?php echo $qid_check?'checked="checked"':'';?>> <label for="ssch_qid"><span class="sound_only"><?php echo _t('상품'); ?></span><?php echo _t('코드'); ?></label>
            <input type="checkbox" name="qbasic" id="ssch_qbasic" value="1" <?php echo $qbasic_check?'checked="checked"':'';?>> <label for="ssch_qbasic"><?php echo _t('기본설명'); ?></label><br>
        </div>
        <div>
            <strong><?php echo _t('상품가격'); ?> <!--(원)--> (<?php echo $g5['currency_unit_name_list'][$g5['def_currency']]; ?>)</strong>
            ...
            <input type="text" name="qto" value="<?php echo $qto; ?>" id="ssch_qto" class="frm_input"> <?php echo _t('까지'); ?><br>
        </div>
        <div>
