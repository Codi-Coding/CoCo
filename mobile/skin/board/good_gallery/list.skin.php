    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            ...
            <ul class="gall_con">
                ...
                <li><span class="gall_subject"><?php echo _t('작성자'); ?> </span><?php echo $list[$i]['name'] ?></li>
                <li><span class="gall_subject"><?php echo _t('작성일'); ?> </span><?php echo $list[$i]['datetime2'] ?></li>
                <li><span class="gall_subject"><?php echo _t('조회'); ?> </span><?php echo $list[$i]['wr_hit'] ?></li>
                <?php if ($is_good) { ?><li><span class="gall_subject"><?php echo _t('추천'); ?></span><strong><?php echo $list[$i]['wr_good'] ?></strong></li><?php } ?>
                <?php if ($is_nogood) { ?><li><span class="gall_subject"><?php echo _t('비추천'); ?></span><strong><?php echo $list[$i]['wr_nogood'] ?></strong></li><?php } ?>
            </ul>
        </li>
        <?php } ?>
