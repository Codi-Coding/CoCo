...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="reg_mb_email"><?php echo _t('E-mail'); ?><strong class="sound_only"><?php echo _t('필수'); ?></strong></label></th>
            <td>
        ...
        <tr>
            ...
            <td>
                <span class="frm_info">
                    ...
                    _t('이렇게 하는 이유는 잦은 정보공개 수정으로 인하여 쪽지를 보낸 후 받지 않는 경우를 막기 위해서 입니다.'); ?>
                </span>
