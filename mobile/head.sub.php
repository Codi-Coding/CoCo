...
if(!defined('G5_IS_ADMIN') && defined('G5_THEME_PATH') && is_file(G5_THEME_MOBILE_PATH.'/head.sub.php')) {
    include_once(G5_THEME_MOBILE_PATH.'/head.sub.php');
    return;
} else if(!defined('G5_IS_ADMIN') && defined('G5_THEME_PATH') && is_file(G5_THEME_PATH.'/head.sub.php')) {
...
if (defined('G5_IS_ADMIN')) {
    ...
    $shop_css = '_shop';
    if(G5_IS_MOBILE) {
        echo '<link rel="stylesheet" href="'.$g5['mobile_tmpl_url'].'/css/'.'default.css">'.PHP_EOL;
        /// echo '<link rel="stylesheet" href="'.$g5['mobile_tmpl_url'].'/css/'.'style.css">'.PHP_EOL;
        add_stylesheet('<link rel="stylesheet" href="'.$g5['mobile_tmpl_url'].'/css/'.'style.css">', 0);
    } else {
