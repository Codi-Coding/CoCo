...
<div id="ssch">
    ...
    <div id="ssch_frm">
        ...
        <div>
            ...
            <input type="checkbox" name="qid" id="ssch_qid" <?php echo $qid_check?'checked="checked"':'';?>> <label for="ssch_qid"><span class="sound_only"><?php echo _t('상품'); ?></span><?php echo _t('코드'); ?></label><br>
