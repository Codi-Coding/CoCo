...
<a href="<?php echo $itemqa_form; ?>" class="itemqa_form qa_wr"><?php echo _t('상품문의 쓰기'); ?><span class="sound_only"> <?php echo _t('새 창'); ?></span></a>
...
<div id="sit_qa_list">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        $is_secret = false;
        if($row['iq_secret']) {
            $iq_subject .= ' <img src="'.G5_MSHOP_SKIN_URL.'/img/icon_secret.gif" alt="'._t('비밀글').'">';
...
<div id="sit_qa_wbtn">
    <a href="<?php echo _t($itemqa_list); ?>" id="itemqa_list" class="btn01"><?php echo _t('더보기'); ?> +</a>
</div>
