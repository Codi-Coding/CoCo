...
$index_title = "$site_name $index_title_comment ";

$g5['title'] = $index_title;
$main_page = 1; /// main, subpage 구분을 위해 추가.  2013.01.18

include_once(G5_MOBILE_TMPL_PATH.'/head.php');
?>
    ...
    <div id="sidx_slide" class="swipe-wrap">
        ...
        <div class="sct_wrap">
            <header>
                ...
                <p class="sct_wrap_hdesc"><?php echo $config['cf_title']; ?> <?php echo _t('이벤트 모음'); ?></p>
            </header>
...
<?php
include_once(G5_MOBILE_TMPL_PATH.'/tail.php');
?>
