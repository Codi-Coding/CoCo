...
<div id="sidx" class="swipe">
    <div id="sidx_slide" class="swipe-wrap">
        ...
        <div class="sct_wrap">
            <header>
                <h2><a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=1"><?php echo _t('HIT ITEM'); ?></a></h2>
        ...
        <div class="sct_wrap">
            <header>
                <h2><a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=2"><?php echo _t('RECOMMEND ITEM'); ?></a></h2>
        ...
        <div class="sct_wrap">
            <header>
                <h2><a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=3"><?php echo _t('NEW ITEM'); ?></a></h2>
        ...
        <div class="sct_wrap">
            <header>
                <h2><a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=4"><?php echo _t('BEST ITEM'); ?></a></h2>
        ...
        <div class="sct_wrap">
            <header>
                <h2><a href="<?php echo G5_SHOP_URL; ?>/listtype.php?type=5"><?php echo _t('SALE ITEM'); ?></a></h2>
