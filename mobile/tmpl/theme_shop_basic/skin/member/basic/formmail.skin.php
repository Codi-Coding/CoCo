...
<div id="formmail" class="new_win mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="fmail"><?php echo _t('E-mail'); ?><strong class="sound_only"><?php echo _t('필수'); ?></strong></label></th>
        ...
        <tr>
            <th scope="row"><label for="file1"><?php echo _t('첨부'); ?> 1</label></th>
            <td><input type="file" name="file1" id="file1" class="frm_input"></td>
        </tr>
        <tr>
            <th scope="row"><label for="file2"><?php echo _t('첨부'); ?> 2</label></th>
