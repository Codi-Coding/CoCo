...
<div id="bo_list">
    ...
    <?php if ($is_checkbox) { ?>
    <div id="list_chk">
        <label for="chkall" class="sound_only"><?php echo _t('게시물 전체'); ?></label>
    ...
    <div class="ul_wrap ul_01">
        <ul>
            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                <?php if ($is_checkbox) { ?>
                <div class="li_chk">
                    <label for="chk_qa_id_<?php echo $i ?>" class="sound_only"><?php echo _t($list[$i]['subject']); ?></label>
                ...
                <div class="li_stat <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($list[$i]['qa_status'] ? _t('답변완료') : _t('답변대기')); ?></div>
            </li>
            <?php
            }
            ?>
