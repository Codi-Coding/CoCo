...
<fieldset id="sch_res_detail">
    ...
    <div>
        ...
        <input type="submit" class="btn_submit" value="<?php echo _t('검색'); ?>">
...
<div id="sch_result">
    ...
    <section id="sch_res_ov">
        <h2><?php echo $stx ?> <?php echo _t('전체검색 결과'); ?></h2>
        <dl>
    ...
    for ($idx=$table_index, $k=0; $idx<count($search_table) && $k<$rows; $idx++) {
     ?>
        <h2><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;<?php echo $search_query ?>"><?php echo $bo_subject[$idx] ?> <?php echo _t('게시판 내 결과'); ?></a></h2>
        <ul>
        <?php
        for ($i=0; $i<count($list[$idx]) && $k<$rows; $i++, $k++) {
         ...
         ?>
            <li>
                ...
                <a href="<?php echo $list[$idx][$i]['href'] ?><?php echo $comment_href ?>" target="_blank"><?php echo _t('새창'); ?></a>
        ...
        <div class="sch_more"><a href="./board.php?bo_table=<?php echo $search_table[$idx] ?>&amp;<?php echo $search_query ?>"><strong><?php echo $bo_subject[$idx] ?></strong> <?php echo _t('결과 더보기'); ?></a></div>
