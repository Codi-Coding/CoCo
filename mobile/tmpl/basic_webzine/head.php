...
<header id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="gnb" class="hd_div">
            ...
            if ($i == 0) {  ?>
                <li id="gnb_empty">메뉴 준비 중입니다.<?php if ($is_admin) { ?> <br><a href="<?php echo G5_ADMIN_URL; ?>/menu_list.php"><?php echo _t('관리자모드'); ?> &gt; <?php echo _t('환경설정'); ?> &gt; <?php echo _t('메뉴설정'); ?></a><?php echo _t('에서 설정하세요.'); ?><?php } ?></li>
            <?php } ?>
            </ul>
            <button type="button" id="gnb_close" class="hd_closer"><span class="sound_only"><?php echo _t('메뉴'); ?> </span><?php echo _t('닫기'); ?></button>
        </div>
