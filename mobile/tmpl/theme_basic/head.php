...
<header id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <ul id="hd_nb">
            ...
            <li><a href="<?php echo G5_BBS_URL ?>/current_connect.php" id="snb_cnt"><?php echo _t('접속자'); ?> <?php echo connect('theme/basic'); // 현재 접속자수 ?></a></li>
            ...
            <?php } ?>
            <?php if (0 and defined('G5_USE_SHOP') && G5_USE_SHOP) { ?>
            <li><a href="<?php echo G5_SHOP_URL ?>/" id="snb_shop"><?php echo _t('쇼핑몰'); ?></a></li>
            <?php } ?>
        </ul>
