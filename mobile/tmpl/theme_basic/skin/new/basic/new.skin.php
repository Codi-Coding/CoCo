...
<fieldset id="new_sch">
    ...
    <input type="text" name="mb_id" value="<?php echo $mb_id ?>" id="mb_id" placeholder="<?php echo _t('검색어(필수)'); ?>" required class="frm_input required">
...
<div class="tbl_head01 tbl_wrap">
    ...
    <?php if ($i == 0)
        echo '<tr><td colspan="3" class="empty_table">'._t('게시물이 없습니다.').'</td></tr>';
    ?>
    </tbody>
    </table>
</div>
