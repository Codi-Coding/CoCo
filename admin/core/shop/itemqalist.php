...
$action_url = EYOOM_ADMIN_URL . "/?dir=shop&amp;pid=itemqalistupdate&amp;smode=1";
...
$sql_common = " from {$g5['g5_shop_item_qa_table']} a left join {$g5['g5_shop_item_table']} b on (a.it_id = b.it_id) left join {$g5['member_table']} c on (a.mb_id = c.mb_id) ";
...
$sql  = " select * $sql_common order by $sst $sod, iq_id desc limit $from_record, $rows ";
...
// Paging 
$paging = $thema->pg_pages($tpl_name,"./?dir=shop&amp;pid=itemqalist&amp;".$qstr."&amp;page=");
