 ...
 * 폼 action URL
 */
$action_url = EYOOM_ADMIN_URL . "/?dir=shop&amp;pid=personalpayformupdate&amp;smode=1";

$anchor_skin = "skin_bs/shop/basic/personalpay_anchor.skin.html";
adm_pg_anchor('anc_spp_info', 		$anchor_skin);
adm_pg_anchor('anc_spp_pay', 		$anchor_skin);

$frm_submit  = ' <div class="text-center margin-top-30 margin-bottom-30"> ';
$frm_submit .= ' <input type="submit" value="확인" id="btn_submit" class="btn-e btn-e-lg btn-e-red" accesskey="s">';
$frm_submit .= !$wmode ? ' <a href="' . EYOOM_ADMIN_URL . '/?dir=shop&amp;pid=personalpaylist&amp;'.$qstr.'" class="btn-e btn-e-lg btn-e-dark">목록</a> ':'';
$frm_submit .= $w == 'u' ? ' <a href="' . EYOOM_ADMIN_URL . '/?dir=shop&amp;pid=personalpayformupdate&amp;w=d&amp;pp_id='.$pp['pp_id'].'" class="btn-e btn-e-lg btn-e-dark">삭제</a> ':'';
$frm_submit .= '</div>';
