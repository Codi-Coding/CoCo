...
echo 'document.location.href = "' . EYOOM_ADMOIN_URL . '/?dir=shop&pid=orderform&od_id='.$od_id.'";'.PHP_EOL;
echo 'else'.PHP_EOL;
echo 'document.location.href = "' . EYOOM_ADMOIN_URL . '/?dir=shop&pid=inorderlist&'.str_replace('&amp;', '&', $qstr).'";'.PHP_EOL;
echo '</script>'.PHP_EOL;
?>