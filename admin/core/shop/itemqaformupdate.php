...
if ($w == "u")
{
    $sql = "update {$g5['g5_shop_item_qa_table']} set iq_subject='$iq_subject', iq_question='$iq_question', iq_answer='$iq_answer' where iq_id='$iq_id' ";
    sql_query($sql);
    ...
    goto_url(EYOOM_ADMIN_URL . "/?dir=shop&pid=itemqaform&amp;w=$w&amp;iq_id=$iq_id&amp;sca=$sca&amp;$qstr");
}
else {
    alert();
}
