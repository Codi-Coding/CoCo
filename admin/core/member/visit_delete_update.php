...
if(!$pass) alert('관리자 비밀번호를 입력해 주십시오.');
...
alert('총 '.number_format($total_count).'건 중 '.number_format($total_count - $total_count2).'건 삭제 완료', EYOOM_ADMIN_URL . '/?dir=member&pid=visit_delete');
?>