...
// pg_anchor - 스코핑
function adm_pg_anchor($anc_id, $skin_file) {
	global $atpl, $anc_cnt, $eyoom_board;
	
	if( !($anc_cnt && isset($anc_cnt)) ) $anc_cnt = true;

	$atpl->define($anc_id, $skin_file);
	$atpl->setScope($anc_id);
	$atpl->assign(array(
		'anc_id' => $anc_id,
